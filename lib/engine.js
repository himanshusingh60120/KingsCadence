...
- SOFT HOOK: after the company + news anchor, add a short, low-pressure tail that gently invites the open, a light curiosity note or soft offer, phrased naturally. Keep the company and the specific news UP FRONT; the hook is a light tail, not the whole subject. Vary the hook across the four emails. e.g. "DroneUp's airspace pivot, a quick thought"; "Echodyne's $40M radar factory, one idea for you"; "DJI's education exit, worth a look?"; "Insitu's Orbital deal, a read for you"; "Global Aerospace and UAS cover, a thought".
- NEVER clickbait or pushy: no "don't miss", "urgent", "act now", no fake scarcity, no exclamation marks. Soft, curious, professional.
- SHORT: aim 5 to 9 words, hard maximum 10. Lowercase or sentence case, conversational, like a busy person typed it, not a report title. No em dashes, use commas.
...
SUBJECT: 5 to 9 words, a CLICK MAGNET that names the COMPANY (${comp}) AND, if there is an event, the specific movement or decision (e.g. "${comp}'s <the movement>"), then a short soft hook that gently invites the open (a light curiosity note or soft offer, never salesy, no exclamation marks). Concrete, never abstract report-title nouns, no banned subject words.${common}`;
...
SUBJECT: 5 to 9 words, name ${comp} and the specific angle of this email, then a short soft hook that gently invites the open. Concrete, no report-title phrasing, no banned subject words.${common}`;
...
SUBJECT: 5 to 9 words, name ${comp} and that exact segment or application, then a short soft hook. No report-title phrasing, no banned subject words.${common}`;
...
SUBJECT: 5 to 9 words, name ${comp} and the specific forward angle, then a short soft hook. No report-title phrasing, no banned subject words.${common}`;
}
