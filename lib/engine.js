...
SUBJECT: short (3 to 7 words), hyper-specific: it must contain a concrete anchor from THIS prospect (the event, a product or segment they actually offer, or the company name), never a phrase that could head any email in the batch. No report-title phrasing, no banned subject words.${common}`;
...
SUBJECT: short (3 to 7 words), naming that exact segment or application. No report-title phrasing, no banned subject words.${common}`;
