...
- CLICK MAGNET RULE: when there is a real event, the subject MUST name BOTH the company AND the specific movement or decision, e.g. "DroneUp's pivot to airspace management", "Echodyne's $40M radar factory", "DJI shuts its education division", "Insitu's Orbital UAV deal". Seeing their own company next to their own news is what earns the open.
...
- SHORT: aim 4 to 8 words, hard maximum 10. Lowercase or sentence case, conversational, like a busy person typed it, not a report title.
...
SUBJECT: 4 to 8 words, a CLICK MAGNET that names the COMPANY (${comp}) AND, if there is an event, the specific movement or decision (e.g. "${comp}'s <the movement>"). Concrete, never abstract report-title nouns, no banned subject words.${common}`;
...
SUBJECT: 4 to 8 words, name ${comp} and the specific angle of this email. Concrete, no report-title phrasing, no banned subject words.${common}`;
...
SUBJECT: 4 to 8 words, name ${comp} and that exact segment or application. No report-title phrasing, no banned subject words.${common}`;
...
SUBJECT: 4 to 8 words, name ${comp} and the specific forward angle. No report-title phrasing, no banned subject words.${common}`;
}
